...
Maintenance log
Name: Santiago López      Mod. date: 04/25/25       Desc: Created main structs 
Name: Ricardo Jáuregui    Mod. date: 04/25/25       Desc: Created functions to read and write files, and process movements
...
Name: Ricardo Jáuregui    Mod. date: 04/28/25       Desc: Added comments to the code
Name: Paola Loredo        Mod. date: 04/28/25       Desc: Finalized the program and cleaned up code
